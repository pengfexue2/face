...
def process(src1,src2,record):
    ...
    warped_corrected_im2 = correct_colours(im1, warped_im2, record[src1])
...
src1,src2 = "huge","yangmi"
process(src1,src2,record)
process(src2,src1,record)